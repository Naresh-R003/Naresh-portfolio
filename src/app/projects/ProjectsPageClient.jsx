    ...
    <div className="mt-10  space-y-6">
        ...
        <section id="impact" className="scroll-mt-28 bg-[#0b0d10]/45 p-0 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur ">
          ...
          <div className="grid gap-4 p-6 sm:grid-cols-2">
            {project.caseStudy.metrics.map((metric) => (
              <div
                key={metric.label}
                className="group rounded-2xl border border-white/10 bg-gradient-to-b from-[#0b0d10]/70 to-[#0b0d10]/40 p-5 shadow-[0_18px_60px_rgba(0,0,0,0.25)] transition hover:border-white/15 hover:shadow-[0_22px_70px_rgba(0,0,0,0.35)]"
              >
      ...
      {project.caseStudy.architecture?.length ? (
        <section id="architecture" className="scroll-mt-28 bg-[#0b0d10]/45 p-0 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur ">
          ...
          <ul className="space-y-3 px-6 pb-6 pt-5 text-base text-white/90">
                  ...
                  <div className="relative">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-3 text-3xl font-semibold text-white">{project.title}</p>
                      </div>
              ...
              <section className="overflow-hidden bg-[#0b0d10]/45 shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur ">
                ...
                <div className="p-8">
                  {active.caseStudy?.overview || active.summary ? (
                    <section
                      id="overview"
                      className="scroll-mt-28 bg-[#0b0d10]/45 p-0 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur [clip-path:polygon(0_0,92%_0,100%_9%,100%_100%,8%_100%,0_92%)]"
                    >
                      <div className="px-6 pt-6">
                        <p className="text-sm font-semibold text-white">Project Overview</p>
                      </div>
                      <p className="px-6 pb-6 pt-4 text-base leading-7 text-white/90">
                        {active.caseStudy?.overview || active.summary}
                      </p>
                    </section>
                  ) : null}
                  ...
                  {active.highlights?.length ? (
                    <section className="mt-6 bg-[#0b0d10]/45 p-0 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur [clip-path:polygon(0_0,92%_0,100%_9%,100%_100%,8%_100%,0_92%)]">
                      <div className="px-6 pt-6">
                        <p className="text-sm font-semibold text-white">Highlights</p>
                      </div>
                      <ul className="grid gap-4 px-6 pb-6 pt-5 lg:grid-cols-2">
                  ...
                  {active.impact ? (
                    <section className="mt-6 bg-[#0b0d10]/45 p-0 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur [clip-path:polygon(0_0,92%_0,100%_9%,100%_100%,8%_100%,0_92%)]">
                      ...
                      <p className="px-6 pb-6 pt-4 text-base leading-7 text-white/90">{active.impact}</p>
                    </section>
                  ) : null}
